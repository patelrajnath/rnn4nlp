...
from is13.rnn.LSTM_adadelta_bilingual_pretrain import modeLSTM_bilingual_pretrain
...
if __name__ == '__main__':
    ...
    data_train = 'data/wmt2016/pretrain_data5_wmt2016qe1.pkl.gz'
    ...
    random.seed(s['seed'])
    rnn = modeLSTM_bilingual_pretrain( nh = s['nhidden'],
                    nc = nclasses,
                    de = s['emb_dimension'],
                    cs = s['win'],
		    emb_src = emb_en,
